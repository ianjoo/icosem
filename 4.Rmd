...
<span style="color:blue">**The call for papers is now closed.**</span>
...
Provisional program (as of 8 Oct 2025) [<span style="color:blue">(pdf)</span>](IcoLL2026Program.pdf)
...
Oral <- read_xlsx('IcoLL2026review.xlsx') %>% 
  ...
  mutate(`[Theme] Title (Author)` = paste0("[", Theme, "] ", AuthorTitle)) %>% 
...
datatable(Program, rownames = FALSE)

cat('List of poster presentations')

datatable(Poster, rownames = FALSE)
